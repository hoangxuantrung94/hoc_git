...
define( 'WPCACHEHOME', '/home/vnsland/domains/vnsland.vn/public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'vnsland_nova');

/** MySQL database username */
define('DB_USER', 'vnsland_nova');

/** MySQL database password */
define('DB_PASSWORD', 'JtwIE7AB');
