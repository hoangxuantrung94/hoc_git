			...
			<div class="pricing-column<?php echo esc_attr( $class ); ?>">
				...
				<div class="pricing-content">
					...
					<div class="pricing-info">
						<p class="text-center"><?php printf( __( 'Property Submit Limit: %s', 'opalmembership' ), absint( $package->property_number ) ) ?></p>
						<p class="text-center"><?php printf( __( 'Featured Property: %s', 'opalmembership' ), absint( $package->featured_property_number ) ) ?></p>
					</div>
					<!-- end pricing info -->
