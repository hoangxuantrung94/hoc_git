...
class Opalestate_API_Keys_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'singular' => esc_html__( 'API Key', 'opalestate' ),     // Singular name of the listed records
			'plural'   => esc_html__( 'API Keys', 'opalestate' ),    // Plural name of the listed records
	...
	public function column_user( $item ) {
		...
		if ( apply_filters( 'opalestate_api_log_requests', true ) ) {
			$actions['view'] = sprintf(
				...
				esc_html__( 'View API Log', 'opalestate' )
			);
		}
	...
	public function get_columns() {
		$columns = array(
			'user'   => esc_html__( 'Username'    , 'opalestate' ),
			'key'    => esc_html__( 'Public Key'  , 'opalestate' ),
			'token'  => esc_html__( 'Token'		  , 'opalestate' ),
			'secret' => esc_html__( 'Secret Key'  , 'opalestate' )
		);
	...
	public function bulk_actions( $which = '' ) {
		...
		<?php submit_button( esc_html__( 'Generate New API Keys', 'opalestate' ), 'secondary', 'submit', false ); ?>
		<?php
