	...
	final class OpalEstate{
		...
		public static function getInstance() {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Opalestate ) ) {
				...
				add_filter( 'opalestate_google_map_api', array( __CLASS__, 'load_google_map_api') );
			}
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'opalestate' ), '1.0' );
		}
		...
		public function setup_constants(){
			...
			if ( ! defined( 'OPALESTATE_VERSION' ) ) {
				define( 'OPALESTATE_VERSION', '1.3.1.1' );
			}
